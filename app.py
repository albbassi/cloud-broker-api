...
contrato_tag = Tag(name="Contrato", description="Adição, visualização e remoção de contratos da base")
item_contrato_tag = Tag(name="ItemContrato", description="Adição, visualização e remoção de itens de contrato da base")
...
def put_contrato(form: ContratoSchema):
    ...
    if (achou):
        ...
        return {"mesage": "Contrato encontrato e dado(s) alterado(s)", "Data da Assinatura": dados.dt_assinatura, "Valor": dados.valor_ctr }
    else:
